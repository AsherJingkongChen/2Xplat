...
from twoxplat.model.depth_anything.da_utils.logger import logger
...
from twoxplat.model.depth_anything.da_utils.reference_view_selector import (
    RefViewStrategy,
...
class DinoVisionTransformer(nn.Module):
    ...
    def _get_intermediate_layers_not_chunked(self, x, n=1, export_feat_layers=[], **kwargs):
        ...
        for i, blk in enumerate(self.blocks):
            ...
            if self.alt_start != -1 and (i == self.alt_start - 1) and x.shape[1] >= THRESH_FOR_REF_SELECTION and kwargs.get("cam_token", None) is None:
                ...
                # strategy = kwargs.get("ref_view_strategy", "middle")
    ...
    def process_attention(self, x, block, attn_type="global", pos=None, attn_mask=None):
        ...
        # x = torch.utils.checkpoint.checkpoint(block, x, pos, attn_mask, use_reentrant=False)
